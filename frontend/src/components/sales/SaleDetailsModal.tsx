      ...
      <div className="relative bg-white dark:bg-surface-dark w-full max-w-3xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-slate-50 dark:bg-white/5 p-6 rounded-3xl flex items-center gap-4">
          ...
          <div className="flex justify-between items-center bg-secondary p-8 rounded-[2rem] text-white shadow-xl">
              <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold uppercase tracking-widest opacity-60">{t('common.total')}</span>
              </div>
              <span className="text-4xl font-black">Q {Number(sale.total).toFixed(2)}</span>
          </div>
        </div>
      </div>
    </div>
